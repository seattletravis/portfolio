    ...
    build:{
        ...
        rollupOptions: {
            input: {
                ...
                tilt3dMenu: resolve(root, 'tilt3dMenu', 'index.html'),
                tilt3dMultiPlayer: resolve(root, 'tilt3dMultiPlayer', 'index.html'),
                tilt3dSinglePlauer: resolve(root, 'tilt3dSinglePlayer', 'index.html'),
                bubbleGum: resolve(root, 'bubbleGum', 'index.html')
            }
        }
    }
})