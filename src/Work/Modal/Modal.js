...
function Modal({ open, setOpenModal, modalID }) {
	...
	const modalData = [
		...
		},
		{
			...
			link: 'https://travislamberte.com/tilt3d/menu',
			url: 'https://travislamberte.com/tilt3d/menu',
		...
		},
		{
			...
			link: 'https://travislamberte.com/snake/',
			url: 'https://travislamberte.com/snake',
